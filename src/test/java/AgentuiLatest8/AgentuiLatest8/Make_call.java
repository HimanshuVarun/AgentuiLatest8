    	 ...
    	 if(is_hold==0)
	       {
	    	 ...
	    	 {
	    		 logger.log(LogStatus.FAIL, "Customer nod added lead id in current_report table ::\t"+leadIdCurrentReport);
	    		 logger.log(LogStatus.FAIL, "Customer nod added lead id in "+date+" table ::\t"+leadIdYearTime);
             }
	    	 if(f==1)
	    	 {
